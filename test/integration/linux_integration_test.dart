...
void main() {
  group('Linux Platform Integration', () {
    ...
    group('Isolate-based async pipeline on Linux', () {
      test('runAsync executes in isolate for large tensors', () async {
        // Create a large tensor that exceeds the isolate threshold
    ...
    group('Full preprocessing pipeline on Linux', () {
      test('ImageNet pipeline end-to-end', () {
        // Simulate HWC image data
    ...
    group('Memory management on Linux', () {
      ...
      test('large tensor allocation and deallocation', () {
        // Test that large tensors can be created and GC'd on Linux
        for (int i = 0; i < 10; i++) {
    ...
    group('DType operations on Linux', () {
      test('all dtype conversions work on Linux', () {
